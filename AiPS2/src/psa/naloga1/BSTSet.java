 ...
 */
public class BSTSet {
	private psa.naloga1.BSTSetNode root;
	
	public BSTSet(psa.naloga1.BSTSetNode root) {
		this.root = root;
	}
	...
	public boolean add(int element) {
		psa.naloga1.BSTSetNode node = new psa.naloga1.BSTSetNode(null, null, null, element);
		if (root == null) {
			this.root = node;
			return true;
		} else {
