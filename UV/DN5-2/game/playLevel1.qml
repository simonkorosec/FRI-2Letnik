        ...
        RowLayout {
            ColumnLayout {
                Rectangle {
                    id: pomoc
                    color: barva  //"blue"
                    Layout.preferredHeight: lvl1.height/3
                ...
                Rectangle {
                    ...
                    Row {
                        ...
                        Repeater {
                            model: vnosModel
                            delegate: DropTile {
                                colorKey: lvl1.barvaPloscic
                                colorText: lvl1.barvaCrk
                                displayLetter: true
                            }
                        }
            ...
            Rectangle { // Rectangle -> Item
                id: slika
                Layout.preferredHeight: lvl1.height * 2/3
                Layout.preferredWidth: lvl1.width / 3
                color: barva //"red"
                Image {
                    id: slikaImg
                    anchors.verticalCenter: parent.verticalCenter
...
//                anchors.margins: 5
                ...
                Repeater {
                    model: crkeModel
                    delegate: DragTile { colorKey: lvl1.barvaPloscic; colorText: lvl1.barvaCrk }
                }
            }
        ...
        settings.onreadystatechange = function() {
            if (settings.readyState === XMLHttpRequest.DONE) {
                if (settings.status && settings.status === 200) {
                    ...
                    lvl1.barvaPloscic = result["barvaPloscic"];
                    lvl1.barvaCrk = result["barvaCrk"];
