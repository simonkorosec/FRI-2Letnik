...
formula <- as.formula("O3 ~ Mesec + Vlaga_min + PM10 + Temperatura_Krvavec_mean + Vlaga_max + Pritisk_max + Pritisk_mean + Postaja + Padavine_mean + Padavine_sum + Glob_sevanje_mean + Temperatura_Krvavec_min + Temperatura_lokacija_max + Sunki_vetra_min + Hitrost_vetra_mean + Hitrost_vetra_max + Vlaga_mean")
